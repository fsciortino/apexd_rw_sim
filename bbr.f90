...
!C    =================================================================
      program bbr
!C    Integrator with relativistic Boneman-Boris
!C    relativistic BB according to Matsumoto, see HS notebook vol16-p12．
...
!C    ##### line numbers in param.txt to be used in the calculation #### パラメータファイルの行数指定
      ipm1=1; ipm2=3; ! starting and ending line of param.txt
